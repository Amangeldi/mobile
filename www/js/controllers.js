    ...
    .controller('homeCtrl', ['$scope', '$stateParams', '$http', 'globalPeremenFac', '$resource', 'welayatFilter', 'katalogFilter', 'facHaysyBazadanZagruzkaEtmeli', '$cookieStore', 'nomerBazaName', '$location', '$mdDialog','ertdayBD', function ($scope, $stateParams, $http, globalPeremenFac, $resource, welayatFilter, katalogFilter, facHaysyBazadanZagruzkaEtmeli, $cookieStore, nomerBazaName, $location, $mdDialog, ertdayBD) {
        ...
        $scope.sort = function (nameF) {
            ...
            if($scope.sortGora === nameF){
                ...
                if($scope.haysy === 'w' && $scope.sortWagtKnop === 'arrow_upward'){
...
///////////////////////////////////////////ELAYAT WE DAYHAN KATALOG////////////////////////////////////////
    ...
    .controller('bildiriCtrl', ['$scope', '$stateParams','globalPeremenFac', '$http', '$resource', function ($scope, $stateParams, globalPeremenFac, $http, $resource) {
        ...
        //Son ayyrmaly HOKMAN
        $scope.welayatlar = [{wariant: "Mary", value: "mary", valueru: "Мары"},
            {wariant: "Ahal", value: "ahal", valueru: "Ахал"},
            {wariant: "Lebap", value: "lebap", valueru: "Лебап"},
            {wariant: "Daşoguz", value: "dasoguz", valueru: "Дашогуз"},
            {wariant: "Balkan", value: "balkan", valueru: "Балкан"},
            {wariant: "Aşgabat", value: "asgabat", valueru: "Ашгабат"}];
        $scope.etraplar = [{wariant: "Sakarçage", value: "sakarcage", welay: "mary", valueru: "Сакарчаге"},
            {wariant: "Bäherden", value: "baharden", welay: "ahal", valueru: "Бахерден"},
            {wariant: "Mersia", value: "mersia", welay: "ahal", valueru: "Мерсиа"},
            {wariant: "Tejen", value: "tejen", welay: "ahal", valueru: "Теджен"},
            {wariant: "Hario", value: "hario", welay: "ahal", valueru: "Харио"},
            {wariant: "Wekil", value: "wekil", welay: "mary", valueru: "Векил"},
            {wariant: "Tagta Bazar", value: "tagta", welay: "mary", valueru: "Тагта Базар"},
            {wariant: "Şatluk", value: "satlyk", welay: "mary", valueru: "Шатлык"},
            {wariant: "Türkmen", value: "turkmen", welay: "lebap", valueru: "Туркмен"},
            {wariant: "Rurkmenbasy", value: "rurkmenbasy", welay: "lebap", valueru: "Руркменбашы"},
            {wariant: "Reyhan", value: "reyhan", welay: "lebap", valueru: "Рейхан"},
            {wariant: "Gorkut", value: "Gorkut", welay: "dasoguz", valueru: "Горкут"},
            {wariant: "Meria", value: "meria", welay: "dasoguz", valueru: "Мериа"}];
...
///////////////////////////////////////////////////////////////////////////////////////////
    ...
    .controller('filterCtrl', ['$scope', '$stateParams', '$http', '$resource','facAutoMark', 'facAutoModel', 'welayatFilter', 'katalogFilter', 'facHaysyBazadanZagruzkaEtmeli','globalPeremenFac','ertdayBD', function ($scope, $stateParams, $http, $resource, facAutoMark, facAutoModel, welayatFilter, katalogFilter, facHaysyBazadanZagruzkaEtmeli, globalPeremenFac, ertdayBD) {
        ...
        $scope.jogapWelayat = function (j) {
            ...
            if(j==='---|-|---'){
                ...
                $scope.welatUgratmak = welayatFilter.welayatYatturmak('');
            }else{
    ...
    .controller('gosmakCtrl', ['$scope', '$stateParams', '$http', '$resource','facAutoMark', 'facAutoModel','$timeout','globalPeremenFac', '$cookieStore','facHaysyBazadanZagruzkaEtmeli','ertdayBD', function ($scope, $stateParams, $http, $resource, facAutoMark, facAutoModel,$timeout,globalPeremenFac,$cookieStore,facHaysyBazadanZagruzkaEtmeli,ertdayBD) {
        ...
        $scope.upload = function(){
            ...
            request.then(function(response){
                ...
                $scope.iFile.push(response.data);
                console.log('Suratlan Spisegi',$scope.iFile);
                // console.log('Suratlan Spisegi2',$scope.iFile.length);
                if($scope.iFile.length===10) {
                    $scope.maxImgBoldy = true;
                }
                $scope.alert();
        ...
        $scope.ugratmak = function (fInfo,fInfoKatalog) {
            //Suratlaryn adlaryny baza gosara belleyas
            if($scope.iFile!=''&& $scope.iFile!=undefined){
                fInfo.glawImg = $scope.iFile[0];
            }
            for(var san=0; san<$scope.iFile.length;san++) {
                if (san == 0) {
            ...
            fInfo.tolemeli = 'yok';
            if(fInfo.bahasy>=100) {
                // $scope.kusrlarInter.tole100
                if(fInfo.bahasy>=500) {
                    if(fInfo.bahasy>=1000) {
                        if(fInfo.bahasy>=10000) {
                            if(fInfo.bahasy>=50000) {
                                console.log('Damaw ' + $scope.kusrlarInter.tole50000 + ' mun tole')
                            }
                            if(fInfo.bahasy<50000) {
                                console.log('Damaw ' + $scope.kusrlarInter.tole10000 + ' mun tole')
                            }
                        }
                        if(fInfo.bahasy<10000) {
                            console.log('Damaw ' + $scope.kusrlarInter.tole1000 + ' mun tole')
                        }
                    }
                    if(fInfo.bahasy<1000) {
                        console.log('Damaw ' + $scope.kusrlarInter.tole500 + ' mun tole')
                    }
                }
                if(fInfo.bahasy<500) {
                    console.log('Damaw ' + $scope.kusrlarInter.tole100 + ' mun tole')
                }
                fInfo.tolemeli = 'hawa';
            }
                    ...
                    if (fInfoKatalog.katUra3 == 'Satlyk') {
                        ...
                        $http({method: "POST", url: "http://a0109349.xsph.ru/tawaremltajirsatlyk", data : fInfo}).then(function (newItem) {
                            ...
                            $http({method: "POST", url: "http://a0109349.xsph.ru/tawar", data : fInfo}).then(function (newItem) {
                                ...
                                //////////////////////////////////////////////COOOOOOOOOKI///////////////////////////////////////////
                                console.log('Baza ugratdym Tajir1');
                                // $scope.formInfo = {};
                            });
                        });
                    }
